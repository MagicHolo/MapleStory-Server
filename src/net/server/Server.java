...
public class Server {
    ...
    public int addChannel(int worldid) {
        ...
        try {
            ...
            if (channelid < ServerConstants.CHANNEL_MIN_SIZE || channelid > ServerConstants.CHANNEL_MAX_SIZE)
                return -2;
    ...
    private int initWorld(Properties p) {
        ...
        try {
            ...
            if (channelCount > ServerConstants.CHANNEL_MAX_SIZE) {
                System.out.println("Maximum number of channels reached.\r\n");
    ...
    public void transferWorldCharacterEntry(MapleCharacter chr, Integer toWorld) {
        lgnWLock.lock();
            ...
            for (World w : wlist) {
                ...
                if (wchars == null) {
                    if (!accountChars.containsKey(accountId)) {
                        ...
                        // this action.
                        accountChars.put(accountId, new HashSet<Integer>());
                    }
                } else if (!wchars.isEmpty()) {
                    lastwchars = wchars;
